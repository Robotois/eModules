...
${OBJECTDIR}/LineFinder.o: LineFinder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineFinder.o LineFinder.cpp

${OBJECTDIR}/LineSensorModule.o: LineSensorModule.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineSensorModule.o LineSensorModule.cpp
...
${OBJECTDIR}/ServoModule.o: ServoModule.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServoModule.o ServoModule.cpp
