...
${OBJECTDIR}/Libraries/DigitalIO/DigitalHeader.o: Libraries/DigitalIO/DigitalHeader.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/DigitalIO/DigitalHeader.o Libraries/DigitalIO/DigitalHeader.cpp

${OBJECTDIR}/Libraries/DigitalIO/DigitalIO.o: Libraries/DigitalIO/DigitalIO.cpp
	${MKDIR} -p ${OBJECTDIR}/Libraries/DigitalIO
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/DigitalIO/DigitalIO.o Libraries/DigitalIO/DigitalIO.cpp

${OBJECTDIR}/Libraries/Kalman/Kalman.o: Libraries/Kalman/Kalman.cpp
	${MKDIR} -p ${OBJECTDIR}/Libraries/Kalman
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libraries/Kalman/Kalman.o Libraries/Kalman/Kalman.cpp
...
${OBJECTDIR}/Modules/AccelGyro/AccelGyroModule.o: Modules/AccelGyro/AccelGyroModule.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/AccelGyro/AccelGyroModule.o Modules/AccelGyro/AccelGyroModule.cpp
...
${OBJECTDIR}/Modules/Button/Button.o: Modules/Button/Button.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/Button/Button.o Modules/Button/Button.cpp
...
${OBJECTDIR}/Modules/LED/LED.o: Modules/LED/LED.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/LED/LED.o Modules/LED/LED.cpp
...
${OBJECTDIR}/Robots/Robert/Robert.o: Robots/Robert/Robert.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Robots/Robert/Robert.o Robots/Robert/Robert.cpp

${OBJECTDIR}/Robots/Robotina/Robotina.o: Robots/Robotina/Robotina.cpp
	${MKDIR} -p ${OBJECTDIR}/Robots/Robotina
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Robots/Robotina/Robotina.o Robots/Robotina/Robotina.cpp
