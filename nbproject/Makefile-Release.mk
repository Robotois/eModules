...
${OBJECTDIR}/robotois-modules/robotois-temp-hum/src/Modules/TempHum/TempHum.o: robotois-modules/robotois-temp-hum/src/Modules/TempHum/TempHum.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/robotois-modules/robotois-temp-hum/src/Modules/TempHum/TempHum.o robotois-modules/robotois-temp-hum/src/Modules/TempHum/TempHum.cpp
